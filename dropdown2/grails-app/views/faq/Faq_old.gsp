...
var question = 1;
document.getElementById(-1).style.backgroundColor="#ffb6ab";


	function showDiv(id){
		var newId = id * -1;
		var newQuestion = question * -1;
		document.getElementById(newQuestion).style.backgroundColor="#ffffff";
		document.getElementById(newId).style.backgroundColor="#ffb6ab";
