...
<div id="warmTitle">
Because your dog deserves a warm meal!&trade;
</div>

<div id="twitpic"><a href="#"><img src="${resource(dir: 'images', file: 'twitter.png')}" height="50px" width="50px" onClick='window.open ("https://twitter.com/intent/follow?original_referer=http%3A%2F%2Flocalhost%3A8080%2Fdropdown%2Fhome%2Findex&screen_name=BillMurray&source=followbutton&variant=2.0","mywindow","menubar=1,resizable=1,width=470,height=510");'></a>
</div>
